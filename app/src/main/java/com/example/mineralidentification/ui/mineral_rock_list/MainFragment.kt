...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_rock_mineral_list, container, false)
    ...
    private class SliderAdapter(ctx: MainFragment, fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        override fun getItem(p0: Int): Fragment {
            return when(p0) {
                0 -> MineralListFragment()
                1 -> RocksListFragment()
                else -> MineralListFragment()
            }
        }
